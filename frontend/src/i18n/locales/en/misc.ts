export default {
  ...
  payment: {
    ...
    balancePay: {
      ...
      insufficientShort: 'Insufficient balance, short {deficit}',
      insufficient: 'Insufficient balance: current {current}, required {required}, short {deficit}',
      insufficientHint: 'Your balance has been refreshed. Top up or choose another payment method.',
      success: 'Balance payment successful. Subscription activated.',
    },
