export default {
    ...
    groups: {
      ...
      modelRouting: {
        title: 'Model Routing',
        tooltip: 'Configure specific model requests to be routed to designated accounts. Supports wildcard matching, e.g., claude-opus-* matches all opus models. Patterns match the model name the client sent, not the channel-mapped upstream model. Routing is a preference, not a restriction: when no routed account is usable the scheduler falls back to normal selection.',
        enabled: 'Enabled',
        disabled: 'Disabled',
        ...
        modelPatternHint: 'Supports a trailing * wildcard, e.g., claude-opus-* matches all opus models. Overlapping patterns have no guaranteed precedence, so avoid them.',
